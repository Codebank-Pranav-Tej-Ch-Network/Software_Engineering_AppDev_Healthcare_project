...
// This is the same reusable toggle component
  ...
  return (
    ...
    >
      ...
      <Stack.Screen options={{
          ...
          headerTitle: "Create Account", // Set the title
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput style={styles.input} placeholder="Enter your name" placeholderTextColor="#9e9e9e" value={name} onChangeText={setName} />
          </View>
          
          <View style={styles.inputContainer}>
            <Ionicons name="mail-outline" size={20} color="#9e9e9e" style={styles.inputIcon} />
            <TextInput style={styles.input} placeholder="Enter your email" placeholderTextColor="#9e9e9e" value={email} onChangeText={setEmail} autoCapitalize="none" keyboardType="email-address" />
          </View>
...
// This stylesheet is identical to the login screen for consistency
